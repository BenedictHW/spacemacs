...
`Listen mode' mode.  If the prefix argument is positive, enable the
...

;;; Generated autoloads from listen-mpv.el

(register-definition-prefixes "listen-mpv" '("listen-mpv-volume"))
